...
description: "Обновление TokenBel: отдельные страницы событий, связи новостей с компаниями и бумагами, AI-дедупликация и открытый MCP-сервер."
date: "2026-06-25"
lastmod: "2026-06-26"
draft: false
tags:
...
* **Публичный MCP-эндпоинт:** запустили [`mcp.tokenbel.dev`](https://mcp.tokenbel.dev/mcp) — открытый сервер без авторизации для AI-агентов и MCP-клиентов (Claude Desktop, Cursor и т.д.). Они читают данные по токенам, акциям, облигациям и компаниям, ищут бумаги по тикеру и компании по названию или УНП.
...
* Запустили публичный MCP-сервер на [mcp.tokenbel.dev](https://mcp.tokenbel.dev/mcp) без авторизации: данные каталога отдаются AI-агентам напрямую через API. Подключить к агенту можно по ссылке `https://mcp.tokenbel.dev/mcp`.
